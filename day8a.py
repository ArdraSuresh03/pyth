...
class Bike(Vehicle):  # Bike is a Vehicle
...
# Example use
car1 = Car("CAR001", 100.0, 4)        # car with 4 seats
bike1 = Bike("BIKE001", 80.0, "Scooter")

print(car1.display_details(), "→ Rent:", calculate_rental(car1))
print(bike1.display_details(), "→ Rent:", calculate_rental(bike1))
